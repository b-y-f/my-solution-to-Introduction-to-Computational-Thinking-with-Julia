...
# ╔═╡ e5e3eefd-d08f-4cd1-9139-d4ecf0146637
function get_greens(image::AbstractMatrix)
	# your code here!
	return get_green.(image)
end

# ╔═╡ 5a88260f-9be9-4653-bb33-b01515ef0cda
function get_blue(pixel::AbstractRGB)
	# your code here!
	return pixel.b
end

# ╔═╡ 54e25801-9a5d-4ba3-9b0d-195d502695fe
...
function mean_color(image)
	# your code here!
	mean_r = mean(get_reds(image))
	mean_g = mean(get_greens(image))
	mean_b = mean(get_blues(image))
